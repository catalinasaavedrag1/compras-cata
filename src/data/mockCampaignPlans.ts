...
export interface CampaignProduct {
  ...
  isNew?: boolean;
  /** Posición del banner dentro de su espacio/placement. 1 = primero / más visible. */
  order?: number;
}
...
export const PLACEMENT_ICON: Record<PlacementKey, string> = {
  ...
  destacado:
    "M20.6 13.4 13.4 20.6a2 2 0 0 1-2.8 0l-7.2-7.2A2 2 0 0 1 2.8 12V4a1 1 0 0 1 1-1h8a2 2 0 0 1 1.4.6l7.4 7.4a2 2 0 0 1 0 2.8zM7 7h.01",
...
export const SPACE_TYPES: SpaceType[] = [
  {
    placement: "banner",
    label: "Banner Home Web",
    channel: "web",
    position: "Home — sobre el fold",
    size: "1080 × 300 px",
    total: 3,
  },
  {
    ...
    channel: "ml",
    position: "Tope de búsqueda ML",
    size: "Ficha + tag oferta",
    total: 8,
  },
  {
    placement: "reel",
    ...
    size: "Video vertical 9:16",
    total: 6,
  },
  {
    placement: "gondola",
    label: "Cabecera de góndola",
    channel: "tienda",
    position: "Pasillo central",
    size: "Físico — cabecera",
    total: 4,
  },
  {
    placement: "vitrina",
    label: "Vitrina tienda",
    channel: "tienda",
    position: "Entrada de tienda",
    size: "Físico — vitrina",
    total: 2,
  },
  {
    ...
    channel: "web",
    position: "Boletín semanal",
    size: "Bloque destacado",
    total: 4,
  },
];
    ...
    products: [
      {
        ...
        channel: "redes",
        placement: "reel",
        placementLabel: "Reel Instagram + TikTok",
        budget: 900000,
        estSale: 4200000,
        status: "ready",
        order: 1,
      },
      {
        ...
        channel: "ml",
        placement: "destacado",
        placementLabel: "Listado destacado ML",
        budget: 780000,
        estSale: 3100000,
        status: "ready",
        order: 1,
      },
      {
        ...
        channel: "web",
        placement: "banner",
        placementLabel: "Banner home web",
        budget: 520000,
        estSale: 2200000,
        status: "pending",
        order: 1,
      ...
      },
      {
        ...
        channel: "tienda",
        placement: "gondola",
        placementLabel: "Cabecera de góndola",
        budget: 300000,
        estSale: 1400000,
        status: "ready",
        order: 1,
      ...
      {
        name: "Taladro percutor + set brocas",
        sku: "HER-006",
        category: "Herramientas eléctricas",
        normal: 59990,
        promo: 44990,
    ...
    products: [
      {
        ...
        channel: "redes",
        placement: "reel",
        placementLabel: 'Reel "renueva tu hogar"',
        budget: 600000,
        estSale: 2800000,
        status: "ready",
        order: 1,
      ...
      {
        name: "Plancha OSB 9,5 mm 1,22x2,44",
        sku: "MAD-001",
        category: "Maderas",
        normal: 18990,
        promo: 16140,
      ...
      },
      {
        ...
        channel: "tienda",
        placement: "vitrina",
        placementLabel: "Vitrina + pendón tienda",
        budget: 400000,
        estSale: 3800000,
        status: "stock_risk",
        order: 1,
      ...
      },
      {
        ...
        channel: "web",
        placement: "banner",
        placementLabel: "Banner categoría",
        budget: 330000,
        estSale: 1500000,
        status: "ready",
        order: 2,
    ...
    products: [
      {
        ...
        channel: "redes",
        placement: "reel",
        placementLabel: 'Reel "asado perfecto"',
        budget: 500000,
        estSale: 1500000,
        status: "ready",
        order: 1,
      ...
      },
      {
        ...
        channel: "ml",
        placement: "destacado",
        placementLabel: "Pack liquidación ML",
        budget: 300000,
        estSale: 980000,
        status: "ready",
        order: 1,
