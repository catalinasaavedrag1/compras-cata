import type { Reception, ReceptionStatus } from "../types/purchasing";

// ============================================================================
//  Recepciones de mercadería vistas por el comprador.
//  Foco: qué viene en camino, qué llegó y cómo llegó (completa / parcial /
//  con problemas de calidad). No es gestión logística fina.
// ============================================================================

export const RECEPTION_STATUS: Record<
  ReceptionStatus,
  { label: string; tone: "blue" | "amber" | "green" | "red" | "violet" | "neutral" }
> = {
  ...
  with_issues: { label: "Con problemas", tone: "red" },
...
export const receptions: Reception[] = [
  {
    ...
    unitsReceived: 0,
    qualityOk: true,
    qualityNote: "En camino. Llega en 3 días.",
    items: [
      { sku: "CON-001", productName: "Cemento Polpaico 25 kg", expected: 700, received: 0 },
      { sku: "MAD-001", productName: "Plancha OSB 9,5 mm", expected: 140, received: 0 },
    ],
  },
  {
    id: "REC-002",
    ...
    unitsReceived: 0,
    qualityOk: true,
    qualityNote: "Despachado por el proveedor. Sin novedades.",
    items: [
      { sku: "ELE-001", productName: "Cable eléctrico THHN 2.5 mm", expected: 96, received: 0 },
      { sku: "ELE-003", productName: "Enchufe triple blanco", expected: 118, received: 0 },
    ],
  },
  {
    id: "REC-003",
    poNumber: "OC-2026-0138",
    supplierName: "Pinturas Nacionales",
    buyer: "María González",
    warehouse: "Balmaceda San Javier",
    ...
    unitsReceived: 0,
    qualityOk: true,
    qualityNote: "Confirmada, pendiente de despacho.",
  },
  {
    id: "REC-004",
    ...
    unitsReceived: 240,
    qualityOk: true,
    qualityNote: "El proveedor no despachó 2 SKUs (80 u.). Reordenar o reclamar.",
    items: [
      { sku: "HER-001", productName: "Taladro percutor Bosch 800W", expected: 70, received: 70 },
  ...
  },
  {
    ...
    unitsReceived: 1200,
    qualityOk: true,
    qualityNote: "Recepción completa y conforme.",
  },
  {
    id: "REC-006",
    poNumber: "OC-2026-0141",
  ...
  },
  {
    ...
    unitsReceived: 0,
    qualityOk: false,
    qualityNote: "22 días de atraso. Escalar con el proveedor.",
  },
  {
    id: "REC-008",
    poNumber: "OC-2026-0132",
    supplierName: "Distribuidora Maule",
    buyer: "Andrea Muñoz",
    warehouse: "Chorrillos San Javier",
  ...
  },
  {
    ...
    unitsReceived: 540,
    qualityOk: true,
    qualityNote: "Recepción conforme.",
  },
  {
    id: "REC-010",
    poNumber: "OC-2026-0129",
    supplierName: "FerrePro Chile",
    buyer: "Juan Pérez",
    warehouse: "Balmaceda San Javier",
    ...
    unitsReceived: 0,
    qualityOk: true,
    qualityNote: "En tránsito. Incluye reposición de teflón y silicona.",
    items: [
      { sku: "GAS-004", productName: "Teflón gasfitería 12 mm", expected: 240, received: 0 },
      { sku: "GAS-002", productName: "Silicona transparente multiuso", expected: 170, received: 0 },
    ],
  },
  {
    id: "REC-011",
  ...
  },
  {
    ...
    unitsReceived: 0,
    qualityOk: true,
    qualityNote: "Programada para fin de mes.",
  },
  {
    id: "REC-013",
    poNumber: "OC-2026-0145",
    supplierName: "Proveedor Andes",
    buyer: "Catalina Saavedra",
    warehouse: "Centro de Distribución",
    createdAt: "2026-06-18",
    ...
    unitsReceived: 760,
    qualityOk: true,
    qualityNote: "El proveedor no despachó 2 SKUs (220 u.). Hay que reordenar o reclamar.",
    items: [
