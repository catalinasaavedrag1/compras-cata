          ...
          <div className="flex-1 min-w-[240px]">
            <div className="flex items-baseline justify-between mb-1.5">
              <span className="text-xs text-slate-500">
                Presupuesto asignado <b className="text-slate-700">{formatCurrency(allocated)}</b>{" "}
                de {formatCurrencyCompact(camp.totalBudget)}
              </span>
                ...
                <div>
                  <p className="text-xl font-bold text-slate-900">
                    ...
                    <span className="text-sm font-medium text-slate-400">
                      de {spacesTotal} cupos
                    </span>
                  </p>
                  <p className="text-xs text-slate-500 mt-0.5">
                    <b className="text-amber-700">{spacesUsed} ocupados</b> · Espacios publicitarios
                    de esta campaña
                  </p>
                </div>
              </div>
