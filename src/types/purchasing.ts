...
// Los estados, mensajes, apoyo y detalle de una señal viven ahora en el
// contrato real del purchase-bff (SignalView / SignalDetailData, F13): aquí
// solo quedan los catálogos que usa el formulario de reporte.
